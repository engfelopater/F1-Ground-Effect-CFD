...
\begin{titlepage}
    \centering
    \vspace*{0.7cm}
    \includegraphics[width=0.82\textwidth]{Picture1.png}
...
\textbf{2.} \textbf{Name:} Mohamed Sherif Salem\hfill \textbf{ID:} 120240330

\vspace{0.3cm}

\textbf{3.} \textbf{Name:} Moahmed Mamoun \hfill \textbf{ID:} 120240256
